...
const filterGames = videogames.filter(videogame =>!!videogame.genders.find(gender => gender === 'RPG' )); //He tenido que mirar la solucion ya que no se para que !!. Yo lo he hecho con ! y no funciona
